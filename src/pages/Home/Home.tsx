...
import { Typography, Button, Box, TextField } from '@mui/material';  // Импортируем TextField
...
const Home = () => {
    ...
    const submittedToday = 112060;
    const foundToday = 56080;
    ...
    return (
        <>
            {loading ? (
                ...
                >
                    <Box sx={{ padding: '20px 0', zIndex: 555522222 }}>
                        <Header />
                    </Box>
                                    ...
                                    <Button
                                        ...
                                        sx={{
                                            ...
                                            '&:hover': {
                                                ...
                                                border: isDarkMode ? '2px solid #2d6448' : '2px solid #b09328',
                                                color: '#ffffff',
                                            },
                                        }}
                                    >
